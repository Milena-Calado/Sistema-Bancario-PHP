...
class ContaController extends AbstractController
{
    ...
    public function deposito(Request $request, ContaRepository $contaRepository, OperacaoRepository $transacaoRepository, AgenciaRepository $agenciaRepository,  EntityManagerInterface $entityManager): Response
    {
